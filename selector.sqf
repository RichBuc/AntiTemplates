...
*/
	...
	case (A3A_hasFGNAAF): {
        switch(true) do {
            default {
                ["Templates\NewTemplates\AAF2017\FGN_AI_AAF_Arid.sqf", west] call A3A_fnc_compatabilityLoadFaction;
                [2, "Using arid FGNAAF Template", _filename] call A3A_fnc_log;
            };
        };
    };
/* disabled until imtegrated
...
switch(true) do{
	...
	case (A3A_hasFGNAAF): {
        switch(true) do {
            default {
                ["Templates\NewTemplates\AAF2017\FGN_AF_Marines_Arid.sqf", east] call A3A_fnc_compatabilityLoadFaction;
                [2, "Using arid USMC Template", _filename] call A3A_fnc_log;
            };
        };
    };
/* disabled until imtegrated
...
if (A3A_has3CBBAF) then {call compile preProcessFileLineNumbers "Templates\NewTemplates\AAF2017\FGN_AAF_Logistics_Nodes.sqf"};
